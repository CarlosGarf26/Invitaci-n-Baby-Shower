...
import { Heart, Sparkles, Mail, Star } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-[#FAF7F2] text-[#4A4337] relative overflow-x-hidden selection:bg-[#EBDDC3]">
      ...
      <main className="relative z-10 max-w-lg mx-auto px-4 py-8 sm:py-12">
        ...
        {/* Top Floating Badge & Envelope Re-open */}
        ...
        {/* Footer */}
        <footer className="text-center py-8 border-t border-[#E8DEC9] mt-10">
          ...
          <p className="text-xs text-[#8F816F] mt-1">
